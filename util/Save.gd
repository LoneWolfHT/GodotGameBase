...
var can_use = false # To avoid spamming quick save and quick load a boolean with a yield is used

# {"transform" : var2str(player.transform), "head_rotation" : head.rotation.x, "ammo" : weapon.ammo}
var SAVE_TABLE = {}
